...
Variants {
    ...
    delegate: PanelWindow {
        ...
        Rectangle {
            ...
            x: (root.recordingController ? root.recordingController.regionX : 0) - padding - overlayWin.screenOriginX
            y: (root.recordingController ? root.recordingController.regionY : 0) - padding - overlayWin.screenOriginY
