...
- **Keyboard Zoom**: Press <kbd>+</kbd> or <kbd>=</kbd> to zoom in, <kbd>-</kbd> to zoom out, and <kbd>0</kbd> to reset zoom to 100%.
- **Stroke Size**: Press <kbd>[</kbd> to decrease stroke size and <kbd>]</kbd> to increase stroke size.
...
| <kbd>+</kbd> / <kbd>=</kbd> | Zoom in canvas |
| <kbd>-</kbd> | Zoom out canvas |
| <kbd>0</kbd> | Reset canvas zoom to 100% |
| <kbd>[</kbd> | Decrease stroke size |
| <kbd>]</kbd> | Increase stroke size |
